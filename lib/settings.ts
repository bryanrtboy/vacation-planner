...
export const AI_DAILY_CAP = Number(process.env.AI_DAILY_CAP ?? process.env.OPENAI_DAILY_CAP ?? 20);
export const AI_PROVIDER = process.env.AI_PROVIDER ?? "gemini";
export const GEMINI_MODEL = process.env.GEMINI_MODEL ?? "gemini-3.5-flash";
export const USAGE_COUNTER_TIME_ZONE = process.env.USAGE_COUNTER_TIME_ZONE ?? "America/Denver";
